      ...
      <div className={`${loading && "z-[-1]"} `}>
        ...
        <main className="bg-[#E3E8F0] min-h-[80vh] py-20">
          <div className="flex flex-col lg:flex-row justify-between items-center px-10">
            ...
            <div className="w-full lg:w-[50%] mt-32">
              <h1
                className={`text-4xl lg:text-6xl leading-[120%] font-[500] text-[#4B5EF7] mb-6 fade-in-up ${tektur.className}`}
              >
                Need Pre-Vetted Talent to Help You Scale?
              </h1>
              <p
                className={`text-3xl text-[#344156] mb-4 fade-in-up ${khand.className}`}
              >
              ...
              {/* Typing Input */}
              <div className="relative w-full lg:w-[75%] fade-in-right">
                <TypingInput
                  className={`bg-transparent border-[#4B5EF7] border-2 w-full p-4 text-2xl mb-6 typing-input ${khand.className} focus:outline-none`}
                  type="text"
                  placeholder=" "
                />
              ...
              <div
                ...
                className={`cursor-pointer bg-[#4B5EF7] h-[52px] w-[250px] text-2xl flex items-center justify-between px-6 find-talent-btn ${tektur.className}`}
              >
                FIND TALENT
                <svg
                  className="ml-auto"
            ...
            {/* Right Section (Globe Animation) */}
            <div className="lg:w-[40%] hidden lg:flex justify-center z[-1] globe-animation">
              <Globe
                globeImageUrl={null}
                ...
                hexPolygonColor={() => {
                  ...
                  const saturation = 0 + Math.random() * 20;
        ...
        <section className="min-h-screen bg-white w-full flex flex-col items-center justify-center px-12 py-20">
          ...
          <p
            ...
            data-aos="fade-up"
            data-aos-delay="100" // Delay for the paragraph
          >
            Build faster, more efficient MVPs with top-tier global talent,
            pre-vetted and ready to help you scale your startup.
          </p>
          <div className="w-full gap-20 flex flex-col lg:flex-row justify-center items-center text-black mt-10">
            <div
              className="py-18 flex flex-col gap-0 justify-center items-center"
              data-aos="fade-up"
              data-aos-delay="200" // Delay for first card
            >
              <lord-icon
              ...
              >
                ...
                hiring. Scale your team efficiently while maintaining quality
                and innovation.
              </p>
            </div>
            <div
              ...
              data-aos="fade-up"
              data-aos-delay="400" // Delay for second card
            >
              <lord-icon
            ...
            <div
              className="flex flex-col gap-0 justify-center items-center"
              data-aos="fade-up"
              data-aos-delay="600" // Delay for third card
            >
              <lord-icon
              ...
              >
                ...
                accelerating development cycles and adapting quickly to market
                trends.
              </p>
            </div>
          </div>
        ...
        <section className="min-h-screen bg-white w-full flex flex-col items-center justify-center px-12">
          <h2
            className={`text-4xl lg:text-6xl text-center leading-[120%] font-[500] text-[#4B5EF7] mb-2 ${tektur.className}`}
            data-aos="fade-up" // Add fade-up effect on scroll
          >
          ...
          <p
            className={`py-2 max-w-[800px] text-3xl text-center leading-[120%] font-[500] text-[#344156] mb-8 ${khand.className}`}
            data-aos="fade-up"
            data-aos-delay="100" // Delay for this element
          >
            Unlock top-tier talent effortlessly with our simple three-step
            process. From consultation to execution, we connect you with the
            best global professionals to scale your business with ease.
          </p>
          <div className="w-full gap-40 flex flex-col lg:flex-row justify-center items-center text-black mt-10 py-12">
            <div
              className="py-18 flex flex-col gap-0 justify-center px-12 relative"
              data-aos="fade-up"
              data-aos-delay="200" // Delay for first block
            >
              <Image
            ...
            <div
              className="py-18 flex flex-col gap-0 justify-center px-12 relative"
              data-aos="fade-up"
              data-aos-delay="400" // Delay for second block
            >
              <Image
                className="absolute z-[1] right-0"
                src="/triangle.png"
            ...
            <div
              className="py-18 flex flex-col gap-0 justify-center px-12 relative"
              data-aos="fade-up"
              data-aos-delay="600" // Delay for third block
            >
              <Image
                className="absolute z-[1] right-0"
                src="/triangle.png"
              ...
              <p
                className={`mt-2 text-wrap text-2xl leading-[120%] font-[500] z-[10] text-[#344156] ${khand.className}`}
              >
                Grow without limits. Whether it&apos;s a single project or a
                long-term collaboration, we provide the expertise and
                flexibility to help you succeed.
              </p>
            </div>
          </div>
        </section>
